...
# rev 5a - fixed the ball colors and ball direction at start
#        - actualy removed stopplay
...
hit_ball.color("black") # Switched ball color to black to prevent eye strain (Rev5a)
hit_ball.penup()
hit_ball.goto(0, 0)
...
def startplay():
    ...
    hit_ball.dy = -5
    hit_ball2.dx = -5
    hit_ball2.dy = 5 # Ball direction fix (Rev5a)

# def stopplay(): # did not work well (Rev5a)
#   hit_ball.dx = 0
#   hit_ball.dy = 0
#   hit_ball2.dx = 0
#   hit_ball2.dy = 0
...
# Define scoring for ball 1
    if hit_ball.xcor() > 500 or hit_ball.ycor() < -300:  # rev 2: added "or hit_ball.ycor() < -300"
        ...
        left_player += 1
    # rev 4 - add sound
        # os.system('afplay /System/Library/Sounds/Sosumi.aiff')  # all rev 4 sound commented out in rev 4a
        sketch.clear()
...
#        # os.system("afplay bounce.wav&")# Adding sound  rev 4
