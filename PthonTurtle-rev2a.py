...
sc.onkeypress(paddlecleft, "1")  # Changed to 'w'(original comment)
# rev 2: "2" key moves top paddle right
sc.onkeypress(paddlecright, "2")  # Changed to 's' (original comment)
# rev 2: "8" key moves bottom paddle left
sc.onkeypress(paddledleft, "8")
# rev 2: "9" key moves bottom paddle right
sc.onkeypress(paddledright, "9")
#
